...
@section('content')
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-8 col-lg-6">
                                ...
                                <input type="text" name="payment_type" id="payment_type" class="form-control" placeholder="Category" required>
                            </div>
                            <div class="col-sm-12 col-md-8 col-lg-6">
    ...
    <script>
        $(function () {
            ...
            var baseurl = window.location.origin+'/payments/';
            var url = '';
